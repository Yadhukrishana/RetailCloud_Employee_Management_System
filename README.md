# RetailCloud_Employee_Management_System

A Spring Boot-based RESTful API to manage Employees and Departments, implementing full CRUD operations, pagination, department transfers, and lookup features.

---

##  Features

- CRUD APIs for Employee and Department entities.
- Pagination support.
- Move employees between departments.
- Lookup functionality.
- Analytics & reporting-friendly structure.
- Layered architecture: Controller → Service → Repository.
- JPA +H2 DB integration 
...
| PUT    | `/api/employees/{empId}/department/{deptId}`  | Move employee to a department        |
| GET    | `/api/employees`                              | Get all employees (paginated)        |
| GET    | `/api/employees/lookup?lookup=true`           | Lookup employee ID and name pairs    |
...
| GET    | `/api/departments?page=0`       | Get all departments (paginated)      |
